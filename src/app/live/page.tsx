...
import type { OF1Session, OF1Driver, OF1Position, OF1Interval, OF1Stint, OF1RaceControl } from "@/lib/types";
    ...
    return (
      <div>
        ...
        <div className="flex flex-col items-center justify-center h-64 gap-3 text-center px-6">
          ...
          <p className="font-semibold">No session data available</p>
          <p className="text-muted text-sm">OpenF1 couldn&apos;t return session info. Try again later.</p>
          <button onClick={init} className="mt-2 flex items-center gap-2 bg-f1-red text-white px-4 py-2 rounded-full text-sm font-semibold">
    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {/* ── Sidebar: track status + race control ── */}
                ...
                <div className="space-y-3">
                  {raceControl.map((m, i) => (
                    <div key={i} className="flex gap-3 text-sm">
                      <span className="text-muted font-mono shrink-0 text-xs pt-0.5">
                        L{m.lap_number ?? "--"}
                      </span>
